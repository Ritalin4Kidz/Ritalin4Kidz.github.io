...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript" src="http://ajax.cdnjs.com/ajax/libs/json2/20110223/json2.js"></script>
    <script type="text/javascript">
		...
		$("#btnNineDigital").live("click", function () {
			var nineDigital =
				{
					"payload": [
						{
		...
		$.ajax({
  		type: 'POST',
  		url: 'Default.aspx/GetNineDigital',
		data: "{ nineDigital: " + JSON.stringify(nineDigital) + " }",
  		contentType: 'application/json; charset=utf-8',
		dataType: 'json',
		error: function (response) {
			alert("Error: Could Not Decode, Invalid JSON");
		},
		success: function (response) {
			alert("Success: Decoded, valid JSON");
		},
          });
	 }); 
  //example JSON Request
  //      $("#btnTvShow").live("click", function () {
  //          var tvShow = {};
  //          tvShow.Name = "Mumbai";
  //          tvShow.Population = 2000;
  //	    $.ajax({
  //		type: 'POST',
  //		url: 'Default.aspx/GetTvShow',
  //		data: "{tvShow:" + JSON.stringify(tvShow) + "}",
  //		contentType: 'application/json; charset=utf-8',
  //		dataType: 'json',
  //		success: function (r) {
  //			alert(r.d.Name);
...
<body>
    ...
    <div>
        <input type="button" id = "btnNineDigital" value="Get Nine Digital" />
    </div>
    </form>
</body>
</html>
